...
const deleteInvoiceItem = (id, i) => {
    ...
    if (id != undefined) {
        axios.delete(`/api/delete_invoice_items/${id}`);
    }
};
...
const subTotal = () => {
    ...
    if (form.value.invoice_items) {
        form.value.invoice_items.map((el) => {
            total = total + el.quantity * el.unit_price;
        });
    }
            ...
            <div class="card__content">
                ...
                <div class="table">
                    ...
                    >
                        ...
                        <p>$ {{ itemCart.unit_price * itemCart.quantity }}</p>
                        <p
